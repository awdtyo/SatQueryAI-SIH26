...
Instructions for AI coding agents (opencode, etc.) working in this repository.
...
Environment variables go in `.env` (never commit this — see `.env.example` for required keys).
